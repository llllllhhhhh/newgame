...
bool UMyGameInstanceSubsystem::SaveEvents(const TArray<UPSVariant*>& EventList, const FString& SlotName)
{
...
TArray<UPSVariant*> UMyGameInstanceSubsystem::LoadEvents(const FString& SlotName)
{
...
void UMyGameInstanceSubsystem::PrintEventInfo(const TArray<UPSVariant*>& EventList)
{
    if (EventList.Num() == 0)
    {
...
void UMyGameInstanceSubsystem::CleanupEvents(TArray<UPSVariant*>& EventList)
{
...
TArray<UPSVariant*> UMyGameInstanceSubsystem::CreateTestEventList()
{
